				...
				<div class="with-sidebar-content <?php echo $gdlr_sidebar['center']; ?> columns">
					...
					<?php while ( have_posts() ){ the_post(); ?>
							...
							<div class="gdlr-standard-style">
								<header class="post-header">
									<?php
										...
										if(!empty($thumbnail)){
											echo '<div class="gdlr-blog-thumbnail ' . gdlr_get_kot_thumbnail_class($gdlr_post_option) . '">';
											echo $thumbnail;
											echo '</div>';
										}
									?>
								...
								<?php
									...
									the_content();
									wp_link_pages( array(
										'before' => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'gdlr_kot' ) . '</span>',
										'after' => '</div>',
										'link_before' => '<span>',
										'link_after' => '</span>' )
									);
						...
						<?php if($theme_option['single-post-author'] != "disable"){ ?>
							...
							<h3 class="post-author-title" ><?php echo __('About Post Author', 'gdlr-kot'); ?></h3>
