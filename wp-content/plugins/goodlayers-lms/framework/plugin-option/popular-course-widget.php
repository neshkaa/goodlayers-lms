	...
	class Goodlayers_Lms_Popular_Course extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Popular Course Widget','gdlr-lms'), 
				array('description' => esc_html__('A widget that show popular courses', 'gdlr-lms')));  
		}
		...
		function widget( $args, $instance ) {
			...
			if($query->have_posts()){
				...
				while($query->have_posts()){ $query->the_post();
					...
					echo ' <span class="gdlr-head">' . esc_html__('Students Registered', 'gdlr-lms') . '</span>';
					echo '</div>';
					echo '</div>';
