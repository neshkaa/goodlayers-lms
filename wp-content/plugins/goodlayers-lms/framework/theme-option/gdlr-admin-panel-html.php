	...
	*/	
	...
	class gdlr_lms_admin_option_html{
		...
		function print_custom_option($settings = array()){
			echo '<div class="gdlr-option-input">' . $settings['option'] . '</div>';
		}
		...
		function print_textarea($settings = array()){
			...
			echo '>';
			if( isset($settings['value']) ){
				echo gdlr_lms_text_filter($settings['value']);
			}else if( !empty($settings['default']) ){
				echo gdlr_lms_text_filter($settings['default']);
			}
			echo '</textarea>';
			echo '</div>';
		}		
		...
		function print_font_combobox($settings = array()){
			...
			echo 'value="' . esc_attr( esc_html__('Sample Font', 'gdlr-lms') ) . '" ';
		...
		function print_skin_settings($settings = array()){
			...
			echo esc_html__('The skin you created can be used in Color / Background Wrapper Section', 'gdlr-lms');
			echo '</div>';
			echo '<div class="clear"></div>';
		...
		function print_upload_box($settings = array()){
			...
			echo 'data-button="';
			echo (empty($settings['button']))? esc_html__('Insert Image', 'gdlr-lms'):$settings['button'];
			echo '" ';
			echo 'value="' . esc_html__('Upload', 'gdlr-lms') . '"/>';
		...
		function print_upload_font($settings = array()){
			...
			echo '<div class="gdlr-upload-font-title">' . esc_html__('Upload font', 'gdlr-lms') . '</div>';
		...
		function print_font_item($value = array()){
			...
			echo '<span class="gdlr-font-input-label" >' . esc_html__('Font Name', 'gdlr-lms') . '</span>';
			...
			// eot type
			echo '<div class="gdlr-font-item">';
			echo '<span class="gdlr-font-input-label" >' . esc_html__('EOT Font', 'gdlr-lms') . '</span>';
			...
			echo '/>';
			echo '<input class="gdlr-upload-font-button gdl-button" type="button" value="' . esc_html__('Upload', 'gdlr-lms') . '" />';
			echo '<div class="clear"></div>';
			echo '</div>';
			
			// ttf format
			echo '<div class="gdlr-font-item last">';
			echo '<span class="gdlr-font-input-label" >' . esc_html__('TTF Font', 'gdlr-lms') . '</span>';
