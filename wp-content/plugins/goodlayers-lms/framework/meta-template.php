<?php
	...
	*/	
	...
	function gdlr_lms_print_description($settings){
		...
		echo '<div class="gdlr-lms-description">' . $settings['default'] . '</div>';
	}
	...
	function gdlr_lms_print_upload_box($settings){
		...
		echo '/>';	
		echo '<input type="button" class="gdlr-lms-upload-button" value="' . esc_html__('Upload', 'gdlr-lms') . '" />';
	}
	...
	function gdlr_lms_print_question($settings){
		...
		echo '<span class="tail">' . esc_html__('Add Question', 'gdlr-lms') . '</span>';
	...
	function gdlr_lms_quiz_template(){	
		...
		echo '<span class="head">' . esc_html__('Question :', 'gdlr-lms') . '</span> ';
		...
		echo '<span class="head">+</span>';
		echo '<span class="tail">' . esc_html__('Add Choice', 'gdlr-lms') . '</span>';		
		echo '</div>'; // quiz-add-choice
		echo '<div class="quiz-remove-question" >' . esc_html__('Remove Question', 'gdlr-lms') . '</div>';
		echo '</div>'; // quiz-add-choice-wrapper
		
		echo '<ol class="quiz-choice" data-quiz-slug="quiz-choice"></ol>';
		
		echo '<div class="quiz-answer">';
		echo '<span class="head">' . esc_html__('Correct answer(s) :', 'gdlr-lms') . '</span> ';
		echo '<textarea type="text" data-quiz="quiz-answer" ></textarea>';
		echo '<span class="tail">' . esc_html__('Use comma (,) for multiple answers', 'gdlr-lms') . '</span> ';
		echo '<div class="clear"></div>';
		echo '<span class="head">' . esc_html__('Score for this question :', 'gdlr-lms') . '</span> ';
