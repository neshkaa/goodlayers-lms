			...
			$options['authorize'] = array(
				...
				'options' => array(
					'authorize-live-mode' => array(
						'title' => esc_html__('Live Mode ', 'tourmaster'),
						'type' => 'checkbox',
						'default' => 'disable',
						'description' => esc_html__('Please turn this option off when you\'re on test mode.','tourmaster')
					),
					'authorize-api-id' => array(
						'title' => esc_html__('Authorize API Login ID', 'tourmaster'),
						'type' => 'text'
					),
					'authorize-transaction-key' => array(
						'title' => esc_html__('Authorize Transaction Key', 'tourmaster'),
						'type' => 'text'
					),
				)
			);
