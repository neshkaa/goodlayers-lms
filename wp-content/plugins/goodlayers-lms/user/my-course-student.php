...
<tr>
	...
	<th align="center" ><?php esc_html_e('Seat', 'gdlr-lms'); ?></th>
	<?php } ?>
	<th align="center" ><?php esc_html_e('Status', 'gdlr-lms'); ?></th>
	<th align="center" ><?php esc_html_e('Code', 'gdlr-lms'); ?></th>
	<?php if($course_options['online-course'] == 'enable'){ ?>
	<th align="center" ><?php esc_html_e('Score', 'gdlr-lms'); ?></th>
	<th align="center" ><?php esc_html_e('Badge', 'gdlr-lms'); ?></th>
	<?php }else{ ?>
	<th align="center" ><?php esc_html_e('Attention', 'gdlr-lms'); ?></th>
		<?php if( $certificate ){ ?>
			<th align="center" ><?php esc_html_e('Certificate', 'gdlr-lms'); ?></th>
		<?php } ?>
	<?php } ?>
</tr>
<?php 
	...
	$temp_sql .= $wpdb->prepare("WHERE course_id = %d ", $_GET['course_id']);
	...
	foreach($results as $result){
		...
		if($course_options['online-course'] == 'enable'){
			...
			$temp_sql .= $wpdb->prepare("WHERE course_id = %d ", $_GET['course_id']);
			$temp_sql .= $wpdb->prepare("AND student_id = %d ", $result->student_id);
