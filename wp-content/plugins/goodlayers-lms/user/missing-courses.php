<h3 class="gdlr-lms-admin-head" ><?php esc_html_e('Attended Courses', 'gdlr-lms'); ?></h3>
...
<?php 
	global $wpdb, $current_user, $gdlr_lms_rating;
	...
	$temp_sql .= $wpdb->prepare("attendance <= cast('%s' as DATETIME) AND ", current_time('mysql'));
