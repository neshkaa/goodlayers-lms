...
if( $current_user->roles[0] == 'student' ){
	$type = empty($_GET['type'])? 'my-courses': $_GET['type'];
}else{
...
<div id="content" class="site-content" role="main">
	<div class="gdlr-lms-content gdlr-page-<?php echo esc_attr($type); ?>">
		<div class="gdlr-lms-container gdlr-lms-container">
			<div class="gdlr-lms-item">
				<div class="gdlr-lms-admin-bar"><?php 
					if( in_array($current_user->roles[0], array('student','subscriber')) ){
