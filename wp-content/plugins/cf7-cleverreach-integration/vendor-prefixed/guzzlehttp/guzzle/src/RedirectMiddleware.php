...
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Exception\BadResponseException;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Exception\TooManyRedirectsException;
