...
namespace pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Handler;

use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Exception\ConnectException;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Exception\RequestException;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Promise\FulfilledPromise;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Promise\PromiseInterface;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Psr7;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\TransferStats;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Utils;
use pxlrbt\Cf7Cleverreach\Vendor\Psr\Http\Message\RequestInterface;
use pxlrbt\Cf7Cleverreach\Vendor\Psr\Http\Message\ResponseInterface;
...
class StreamHandler
{
    ...
    public function __invoke(RequestInterface $request, array $options)
    {
        ...
        try {
            ...
            return \pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Promise\rejection_for($e);
        }
    }
    ...
    private function createResponse(RequestInterface $request, array $options, $stream, $startTime)
    {
        ...
        $headers = \pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\headers_from_lines($hdrs);
        ...
        if (isset($options['on_headers'])) {
            try {
                ...
                return \pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Promise\rejection_for($ex);
            }
        }
    ...
    private function checkDecode(array $options, array $headers, $stream)
    {
        ...
        if (!empty($options['decode_content'])) {
            $normalizedKeys = \pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\normalize_header_keys($headers);
    ...
    private function add_proxy(RequestInterface $request, &$options, $value, &$params)
    {
        if (!\is_array($value)) {
            ...
            if (isset($value[$scheme])) {
                if (!isset($value['no']) || !\pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\is_host_in_noproxy($request->getUri()->getHost(), $value['no'])) {
    ...
    private function add_verify(RequestInterface $request, &$options, $value, &$params)
    {
        if ($value === \true) {
            ...
            if (\PHP_VERSION_ID < 50600) {
                $options['ssl']['cafile'] = \pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\default_ca_bundle();
            }
    ...
    private function add_debug(RequestInterface $request, &$options, $value, &$params)
    {
        ...
        $value = \pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\debug_resource($value);
