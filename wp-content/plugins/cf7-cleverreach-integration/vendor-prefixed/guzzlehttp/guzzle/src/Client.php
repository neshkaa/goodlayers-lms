...
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Cookie\CookieJar;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Exception\GuzzleException;
use pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\Promise;
...
use pxlrbt\Cf7Cleverreach\Vendor\Psr\Http\Message\UriInterface;
/**
...
class Client implements ClientInterface
{
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        if (isset($options['json'])) {
            $options['body'] = \pxlrbt\Cf7Cleverreach\Vendor\GuzzleHttp\json_encode($options['json']);
            unset($options['json']);
            // Ensure that we don't have the header in different case and set the new value.
            $options['_conditional'] = Psr7\_caseless_remove(['Content-Type'], $options['_conditional']);
