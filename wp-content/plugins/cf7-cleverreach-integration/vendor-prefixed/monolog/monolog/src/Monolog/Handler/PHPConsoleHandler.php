...
use pxlrbt\Cf7Cleverreach\Vendor\Monolog\Utils;
use pxlrbt\Cf7Cleverreach\Vendor\PhpConsole\Connector;
use pxlrbt\Cf7Cleverreach\Vendor\PhpConsole\Handler;
use pxlrbt\Cf7Cleverreach\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('pxlrbt\\Cf7Cleverreach\\Vendor\\PhpConsole\\Connector')) {
