...
class MongoDBHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!($mongo instanceof \MongoClient || $mongo instanceof \Mongo || $mongo instanceof \pxlrbt\Cf7Cleverreach\Vendor\MongoDB\Client)) {
    ...
    {
        if ($this->mongoCollection instanceof \pxlrbt\Cf7Cleverreach\Vendor\MongoDB\Collection) {
