...
$("body").append(editbox).addClass("gdlr-disable-scroll");        editbox.fadeIn(150);
		editbox.fadeIn(150);
	...
	$.fn.gdlrEditBoxTinyMCE = function( option ){	
		...
		if( typeof(tinyMCE) != "undefined" ){
			...
			current_tinymce = $('<div class="gdlr-tinymce wp-core-ui wp-editor-wrap html-active" data-id="' + tinymce_id + '" >\
								<div id="wp-gdlr_core_tmce-editor-tools" class="wp-editor-tools hide-if-no-js">\
								<div id="wp-gdlr_core_tmce-media-buttons" class="wp-media-buttons">\
								<button type="button" id="insert-media-button" class="button insert-media add_media" data-editor="' + tinymce_id + '">\
								...
								<div id="wp-gdlr_core_tmce-editor-container" class="wp-editor-container">\
								<textarea class="wp-editor-area" autocomplete="off" cols="40" name="' + option.attr('data-name') + '" id="' + tinymce_id + '" >' + gdlr_esc_attr(value) + '</textarea>\
								</div>\
								</div>');
		}			
