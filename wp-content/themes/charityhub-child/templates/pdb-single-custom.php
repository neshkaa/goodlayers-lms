...
<div class="wrap <?php echo $this->wrap_class ?>">
  ...
  // custom
    if ( $this->group->name == 'brand' ) {
          $this->group->value = 'brrrand';
      }
  ...
  ?>
   ...
   <div class="section <?php $this->group->print_class() ?>" id="<?php echo Participants_Db::$prefix.$this->group->name ?>">
    ...
    //custom code
      if ( $this->field->name == 'cruelty_free' ) {
          $this->field->value = $thisname . 'is cruelty-free.';
      }
      
    // skip any field found in the exclude array
 if ( in_array( $this->field->name, $exclude = array()) ) continue;
 $exclude = array('fcod', 'email1', 'logo');
