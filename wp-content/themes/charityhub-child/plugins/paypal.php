<!-- Замества paypal.php в папката на оригиналната тема, за да работи превода на БГ -->
...
if( !function_exists('gdlr_paypal_form') ){
	function gdlr_paypal_form($atts){
		extract( shortcode_atts(array('user'=>'', 
			...
			'currency_format'=>'', 'currency_code'=>'EUR',
...
<div class="gdlr-paypal-form-wrapper">
	<h3 class="gdlr-paypal-form-head"><?php 
	            ...
	            echo __('Вие дарявате :','gdlr_translate') . ' <span>' . get_the_title() . '</span>';
                } else {
	...
	<form class="gdlr-paypal-form" action="<?php echo $action; ?>" method="post" data-ajax="<?php echo AJAX_URL; ?>" >
		<div class="gdlr-paypal-amount-wrapper">
			...
			<input type="text" class="custom-amount" data-default="<?php
			    ...
			    if (pll_current_language() == 'bg'){
                echo __('Сума по Ваш избор', 'gdlr_translate') . '('. $currency_code . ')';
		        } else {
		...
		<input type="radio" id="pp" name="payment-method" value="paypal">
<label for="paypal">PayPal</label><br>
<input type="radio" id="stripe" name="Payment-method" value="stripe">
<label for="stripe" checked="checked">Stripe</label><br>
