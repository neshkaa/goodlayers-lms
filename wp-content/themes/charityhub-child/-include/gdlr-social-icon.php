<?php
	...
	*/
	...
	$gdlr_header_social_icon = array(
		...
		'tiktok'    	=> __('Tiktok','gdlr_translate'),
	...
	if( !function_exists('gdlr_get_social_shares') ){
		function gdlr_get_social_shares(){	
            ...
            <span class="social-share-title">    
                <?php if ($_SERVER['SERVER_NAME'] == 'rescue.thelastcage.org' && ( get_post_type() === 'post' ) ) {
                        printf( pll__("СПОДЕЛИ ", 'gdlr-kot'));
                      } elseif ($_SERVER['SERVER_NAME'] == 'rescue.thelastcage.org' && ( get_post_type() === 'kot' )  ){
                        printf( pll__('СПОДЕЛИ и помогни на %s да намери своите Хора:', 'gdlr-kot'), get_the_title() ); 
                      } else {
           	            pll_e('Share Post:', 'gdlr_translate'); 
           }?> </span>

<?php if($theme_option['facebook-share'] == 'enable'){ ?>
	<a href="http://www.facebook.com/share.php?u=<?php echo $current_url; ?>" target="_blank">
		<img src="/wp-content/uploads/2019/12/facebook_32.png" alt="facebook-share" width="32" height="32" />
	</a>
<?php } ?>
...
<?php if($theme_option['twitter-share'] == 'enable'){ ?>
	<a href="http://twitter.com/home?status=<?php echo str_replace('%26%23038%3B', '%26', $page_title) . ' - ' . $current_url; ?>" target="_blank">
		<img src="/wp-content/uploads/2019/12/twitter_32.png" alt="twitter-share" width="32" height="32" />
	</a>
<?php } ?>
...
<?php if($theme_option['linkedin-share'] == 'enable'){ ?>
	<a href="http://www.linkedin.com/shareArticle?mini=true&#038;url=<?php echo $current_url; ?>&#038;title=<?php echo $page_title; ?>" target="_blank">
		<img src="/wp-content/uploads/2019/12/linkedin_32.png" alt="linkedin-share" width="32" height="32" />
	</a>
<?php } ?>
