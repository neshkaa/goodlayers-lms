<?php
	...
	*/
	...
	if( function_exists('apply_shortcodes') ){
		add_action('wp_nav_menu_item_custom_fields', 'gdlr_wp_nav_menu_item_custom_fields', 10, 4);
	}else{
	...
	if( !function_exists('gdlr_wp_nav_menu_item_custom_fields') ){
		function gdlr_wp_nav_menu_item_custom_fields($id, $item, $depth, $args){
