<?php get_header(); ?>
	...
	<div class="gdlr-content">
		...
		<style scoped>
			#right-sidebar-content-mobile {
				display: none
			}
			#right-sidebar-content-mobile .gdlr-styled-box-body {
		...
		<div class="gdlr-item-start-content sidebar-right-item" id="right-sidebar-content-mobile" >
