...
{name: "kot-filter-text", selector: ".kot-item-filter a{ color: #gdlr#; }"},
{name: "kot-filter-text-hover", selector: ".kot-item-filter a:hover, .kot-item-filter a.active, .kot-item-filter .sep{ color: #gdlr#; }"},
{name: "kot-thumbnail-hover-background", selector: ".gdlr-image-link-shortcode .gdlr-image-link-overlay, .kot-thumbnail .kot-overlay{ background-color: #gdlr#; }"},
{name: "kot-thumbnail-hover-icon", selector: ".gdlr-image-link-shortcode .gdlr-image-link-icon, .kot-thumbnail .kot-icon i{ color: #gdlr#; }"},
{name: "kot-title-color", selector: ".kot-title a{ color: #gdlr#; }"},
{name: "kot-title-hover-color", selector: ".kot-title a:hover{ color: #gdlr#; }"},
{name: "kot-info-color", selector: ".kot-info, .kot-info a{ color: #gdlr#; }"},
{name: "modern-kot-title-color", selector: ".kot-item-holder .gdlr-modern-kot .kot-title a{ color: #gdlr#; }"},
